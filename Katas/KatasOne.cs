...
public class KatasOne
{
    ...
    // If start value is greater than the end, your function should return 0. If end is not the result of an integer number of steps, then don't add it to the sum. See the 4th example below.
    public static int SequenceSum(int start, int end, int step)
    {
        var sequenceSum = start;
    ...
    public static bool IsValidWalk(string[] walk)
    {
        ...
        {
            completeRoute += directions[direction];
        }
